...
export default function ProductCard() {
  return <>
    <div className="w-[245px] h-[383px] bg-card relative overflow-hidden">
      <img src="../../public/images/image 1.png" alt="" className="w-full" />
      ...
      <div className="absolute w-full h-full bg-[#666666bf] z-10 top-0 flex-center opacity-100 duration-200">
        <div className="w-full flex flex-col items-center">
          ...
          <div className="flex-center-between text-sm w-11/12 text-white font-bold mt-6">
            <span className="flex gap-x-1"><IoShareSocialOutline className="text-xl"/> Share</span>
            <span className="flex gap-x-1"><MdOutlineCompareArrows className="text-xl" /> Compare</span>
            <span className="flex gap-x-1"><IoHeartOutline className="text-xl" />Like</span>
          </div>
        </div>
      </div>
    </div>
